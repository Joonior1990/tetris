...
// export const LIST_OF_FIGURES = [FIGURE_TYPE_I, FIGURE_TYPE_T, FIGURE_TYPE_O, FIGURE_TYPE_J, FIGURE_TYPE_L, FIGURE_TYPE_S];
export const LIST_OF_FIGURES = [FIGURE_TYPE_S];
